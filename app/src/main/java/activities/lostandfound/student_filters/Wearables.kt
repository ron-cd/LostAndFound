...
/**
 * Activity for displaying and filtering posts specifically in the 'Wearables' category.
 */
class Wearables : AppCompatActivity() {
    ...
    /**
     * Handles system bar padding and sets fullscreen flags for immersive viewing.
     */
    ...
    /**
     * Sets up the TextWatcher for real-time item searching within Wearables.
     */
    ...
    /**
     * Configures navigation listeners.
     */
    ...
    /**
     * Filters the local list based on user input for item names.
     */
    ...
    /**
     * Listens for real-time Firestore updates specifically for approved 'Wearables' posts.
     */
    ...
    private fun getPostData() {
        ...
        db.collection("posts")
            ...
            .whereEqualTo("category", "Wearables")
