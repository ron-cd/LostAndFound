...
/**
 * Activity for displaying and filtering posts specifically in the 'Bags' category.
 */
class Bags : AppCompatActivity() {
    ...
    /**
     * Initializes views and sets up the RecyclerView adapter.
     */
    ...
    /**
     * Configures the search field with a TextWatcher for real-time filtering.
     */
    ...
    /**
     * Configures click listeners for navigation components.
     */
    ...
    /**
     * Listens for real-time Firestore updates specifically for approved 'Bags' posts.
     */
