...
/**
 * Activity for displaying and filtering posts specifically in the 'Personal Items' category.
 */
class Personal : AppCompatActivity() {
    ...
    /**
     * Handles system bar padding and fullscreen UI flags.
     */
    ...
    /**
     * Initializes views and sets up the RecyclerView.
     */
    ...
    /**
     * Configures the TextWatcher for real-time searching within Personal Items.
     */
    ...
    /**
     * Filters the local list based on user input.
     */
    ...
    /**
     * Listens for real-time Firestore updates for approved 'Personal Items' posts.
     */
    ...
    private fun getPostData() {
        ...
        db.collection("posts")
            ...
            .whereEqualTo("category", "Personal Items")
